...
def minOperations(n):
    """
    Calculates the minimum number of copy and paste operations needed to reach n characters.
    ...
    while curr_len < n:
        # Find the largest power of 2 that's less than or equal to the difference
        diff = n - curr_len
